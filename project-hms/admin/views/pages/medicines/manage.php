        ...
        <div class="card-body p-20">
            <div class="default-table-area all-products">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-1">
                                        <!-- Edit Button -->
                                        <a href="?page=medicines/edit&id=<?= $row['id'] ?>">
                                        ...
                                        <form method="POST">
                                            ...
                                            <button type="submit" class="ps-0 border-0 bg-transparent lh-1 position-relative top-2" onclick="return confirm('Are you sure you want to delete this medicine?')">
                ...
                <div class="d-flex justify-content-center justify-content-sm-between align-items-center text-center flex-wrap gap-2 showing-wrap">
                    <span class="fs-12 fw-medium">Showing <?= count($medicines) ?> of <?= count($medicines) ?> Results</span>
