...
$roles = Role::readAll();
if(isset($_GET['id'])){
  $row = User::readById($_GET['id']);  //bujhi nai id t koi theke aslo
  echo '<pre>';
  print_r($row);
  echo '</pre>';
  if(!$item){
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              <!-- form start -->
              <?php if(isset($not_found)): //ata bujha lagbe ?>
               <h5>Data not found.</h5>
              <?php else: ?>
              <form action="" method="POST">
                
                <input type="hidden" value="<?= $row['id']; ?>" name="id"> <!-- ata ken diche -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="role_id">
                      ...
                      $selected = $item['id'] == $row['role_id'] ? 'selected' : ''; //ata bujha lagbe
                      ?>                      
